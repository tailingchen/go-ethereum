...
func NewEventSystem(eventPool *event.FeedPool, backend Backend, lightMode bool) *EventSystem {
	m := &EventSystem{
		eventPool: eventPool,
		backend:   backend,
		lightMode: lightMode,
