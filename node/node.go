...
type Node struct {
	eventPool *event.FeedPool // Event multiplexer used between the services of a stack
	config    *Config
...
// EventPool retrieves the event multiplexer used by all the network services in
// the current protocol stack.
func (n *Node) EventPool() *event.FeedPool {
	return n.eventPool
}
