...
// database.
func (t *table) AppendAncient(number uint64, hash, header, body, receipts, td, transferLog []byte) error {
	return t.db.AppendAncient(number, hash, header, body, receipts, td, transferLog)
}
